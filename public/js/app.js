...
var quantityElem = document.getElementById('qteInput');
...
if (quantityElem) {
  quantityElem.addEventListener('input', function () {
    ...
    shopTotalElem.innerHTML = "Total: ".concat((price * quantityElem.value).toFixed(2), "$");
  });
}
...
__webpack_require__(/*! F:\Projects\Laravel\laravel-ecommerce\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! F:\Projects\Laravel\laravel-ecommerce\resources\sass\app.scss */"./resources/sass/app.scss");
